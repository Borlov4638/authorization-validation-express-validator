...
export const authNewPasswordValidation = () => body('newPassword').exists().withMessage({message:"password is not passed", field:"password"}).isString().isLength({min:1}).withMessage({message:"password is invalid", field:"password"})
