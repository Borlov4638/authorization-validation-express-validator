...
const blogNameValidation = () => (0, express_validator_1.body)('name').isString().trim().isLength({ min: 1, max: 15 }).withMessage({ message: 'Invalid name', field: "name" });
exports.blogNameValidation = blogNameValidation;
const blogDescriptionValidation = () => (0, express_validator_1.body)('description').isString().trim().isLength({ min: 1, max: 500 }).withMessage({ message: 'Invalid description', field: "description" });
exports.blogDescriptionValidation = blogDescriptionValidation;
const blogUrlValidation = () => (0, express_validator_1.body)('websiteUrl').isString().trim().isLength({ min: 1, max: 100 }).withMessage({ message: 'Invalid websiteUrl', field: "websiteUrl" });
